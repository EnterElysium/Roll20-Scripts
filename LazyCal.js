...
var LazyCalendar = LazyCalendar || (function() {
    ...
    const styles = {
        ...
        menu:  'background-color: #fff; border: 1px solid #000; padding: 5px; border-radius: 0px;',
    ...
    showToPlayers = (details='full') => {
        ...
        if(details === 'full' || details === 'date')
            contents += '<br><b><i><p style="text-align:center">'+getDateString()+'AC</p></i></b>';
...
//            if(details === 'full') contents += '<hr>';
    ...
    sendMenu = () => {
        ...
        let buttons = {
            ...
            showHolidays: make.button('Events', command + ' show events', styles.button),
    ...
    make = {
        ...
        title: (title) => {
            return '<h3 style="margin-bottom: 10px;font-size: 16px;text-transform: capitalize;font-variant: small-caps;font-weight: bold;color: #7e2d40;font-family: &quot;Times New Roman&quot;, Times, serif;">'+title+'</h3>';
        },
    ...
    setDefaults = (reset) => {
        const defaults = {
            ...
            calendar:{
                ...
                months: [
                    { name: "Wildmoot", days: 29, avg_temp: 10, weather_type: 0 },
                    { name: "Wildleap", days: 29, avg_temp: 10, weather_type: 0 },
                    { name: "Wildwane", days: 29, avg_temp: 10, weather_type: 0 },
                    { name: "Searsmoot", days: 29, avg_temp: 10, weather_type: 1 },
                    { name: "Searshigh", days: 29, avg_temp: 10, weather_type: 1 },
                    { name: "Searswane", days: 29, avg_temp: 10, weather_type: 1 },
                    { name: "Fallmoot", days: 29, avg_temp: 10, weather_type: 1 },
                    { name: "Fallhale", days: 29, avg_temp: 10, weather_type: 1 },
                    { name: "Fallwane", days: 29, avg_temp: 10, weather_type: 0 },
                    { name: "Wintermoot", days: 29, avg_temp: 10, weather_type: 0 },
                    { name: "Winterdeep", days: 29, avg_temp: 10, weather_type: 2 },
                    { name: "Winterwane", days: 29, avg_temp: 10, weather_type: 2 },
                ],
                seasons: [
                    { name: "Autumn", months: "7-9" },
                    { name: "Winter", months: "10-12" },
                    { name: "Spring", months: "1-3" },
                    { name: "Summer", months: "4-6" },
                ],
                leap: {
                    year: 0,
                    month: 0
